...
import com.andreinsigne.moviegeek.ui.fragments.*
...
class MainActivity : CommonActivity(), YouTubePlayer.OnInitializedListener {
    ...
    override fun moveToRecommendations() {
        supportFragmentManager.beginTransaction().replace(homeContainerLayout.id, MovieRecommendations.newInstance()).addToBackStack(null).commit()
