...
class MovieProfile : MainFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        movieViewModel.getDetails(dataInterface!!.selectedMovieDB()!!.id.toString()).observe(this, Observer {
                ...
                movieDetailsSimilarButton.setOnClickListener { appTransitionInterface!!.moveToSimilar() }
                movieDetailsRecommendationsButton.setOnClickListener { appTransitionInterface!!.moveToRecommendations() }
        })
